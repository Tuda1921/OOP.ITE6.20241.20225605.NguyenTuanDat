    ...
    void initialize() {
        ...
        tfFilter.textProperty().addListener(
            ...
            private void showFilteredMedia(String keyword) {
                // Ensure that cart.getItemsOrdered() returns an ObservableList
                ObservableList<Media> itemsOrdered = cart.getItemsOrdered(); // cart is an instance of Cart
                FilteredList<Media> filteredList = new FilteredList<>(itemsOrdered);
